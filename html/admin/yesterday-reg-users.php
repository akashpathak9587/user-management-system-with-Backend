    ...
    <main id="mainPage">
        ...
        <section class="main">
            <div class="main-title">
                <h1>Yesterday Registered Users</h1>
            </div>
            <div class="sub-title">
                <h1><a href="dashboard.html">Dashboard </a>/ Yesterday Registered Users</h1>
            </div>
            <div class="table-container">
                <div class="table-container-title">
                    <h1> <i class="fas fa-table"> </i>Yesterday Registered Users Details</h1>
                </div>
