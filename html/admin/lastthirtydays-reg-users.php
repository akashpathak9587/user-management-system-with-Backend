    ...
    <main id="mainPage">
        ...
        <section class="main">
            <div class="main-title">
                <h1>Registered Users in Last 30 Days</h1>
            </div>
            <div class="sub-title">
                <h1><a href="dashboard.html">Dashboard </a>/ Registered Users in Last 30 Days</h1>
            </div>
            <div class="table-container">
                <div class="table-container-title">
                    <h1> <i class="fas fa-table"> </i>Registered Users in Last 30 Days Details</h1>
                </div>
